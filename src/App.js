        ...
        <div className="content-area">
          <Sidebar
            home={
              <Navigation
                class={`side-nav__item ${
                  activeState.homeActive ? "side-nav__item--active" : ""
                }`}
                navTo="./home"
            ...
            about={
              <Navigation
                class={`side-nav__item ${
                  activeState.aboutActive ? "side-nav__item--active" : ""
                }`}
                navTo="./about"
                linkClass="side-nav__link"
                navName="About"
            ...
            projects={
              <Navigation
                class={`side-nav__item ${
                  activeState.projectsActive ? "side-nav__item--active" : ""
                }`}
                navTo="./projects"
                linkClass="side-nav__link"
                navName="Projects"
            ...
            contact={
              <Navigation
                class={`side-nav__item ${
                  activeState.contactActive ? "side-nav__item--active" : ""
                }`}
                navTo="./contact"
                linkClass="side-nav__link"
                navName="Contact"
