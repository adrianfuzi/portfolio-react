            ...
            <main className="page page-about" id="about">
                <div className="content content-about">
                    ...
                    <p className="content__text">
                        ...
                        I have a solid understanding of the core web technologies including <b>HTML</b>, <b>CSS(Sass)</b>, <b>JavaScript</b>, as well as other tools such as <b>Bootstrap</b> and <b>WordPress</b> to build, host and maintain beautiful, mobile responsive and functional websites. In addition to these technologies, I have a basic grasp of <b>React</b>, with which this website was built. I also possess the fundamental skills of web design and skills in related technologies such as Adobe <b>Photoshop</b>, <b>Illustrator</b> and Google's design and prototyping tool <b>Figma</b>.<br></br><br></br>
                    ...
                    <a className="download__resume" href="../../../public/cv_adrian_fuzi.pdf" download><svg className="download__resume-icon" width="36" height="44" viewBox="0 0 36 44" fill="none">
