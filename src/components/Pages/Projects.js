        ...
        return (
            <main className="page page-projects" id="projects">
                <div className="content content-projects">
                    ...
                    <div className="projects">
                        <figure className="projects__item">
                            ...
                            <a href="http://the-man-tau.com/" target="_blank" className="projects__overlay" onMouseEnter={toggleHover} onMouseLeave={toggleHover}>
                                ...
                                <p className={`projects__description ${hover ? 'moveInRight' : ''}`}>Home page of a musician.<br></br>Built with: HTML, Sass, JavaScript, PHP<br></br><br></br><span className="projects__heading-visit">Click to visit website</span></p>
                            </a>
                        </figure>
                    ...
                    <div className="projects">
                        <figure className="projects__item">
                            <img src={portfolio} alt="This Website" className="projects__photo"></img>
                            <a href="https://adrianfuzi-portfolio.netlify.com/" target="_blank" className="projects__overlay" onMouseEnter={toggleHover} onMouseLeave={toggleHover}>
                                ...
                                <p className={`projects__description ${hover ? 'moveInRight' : ''}`}>A portfolio design template.<br></br>Built with: HTML, Sass, JavaScript<br></br><br></br><span className="projects__heading-visit">Click to visit website</span></p>
                            </a>
                        </figure>
