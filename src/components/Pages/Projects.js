                ...
                <div className="content content-projects">
                    ...
                    <div className="projects">
                        <figure className="projects__item">
                            ...
                            <a href="http://cubecloud.netlify.com/" target="_blank" rel="noopener noreferrer" className="projects__overlay" onMouseEnter={toggleHover} onMouseLeave={toggleHover}>
                                ...
                                <p className={`projects__description ${hover ? 'moveInRight' : ''}`}>Landing page of a fictional company (Mobile Responsive).<br></br>Built with: HTML, Sass, JavaScript (Work in Progress)<br></br><br></br><span className="projects__heading-visit">Click to visit website</span></p>
                            </a>
                        </figure>
                    ...
                    <div className="projects">
                        <figure className="projects__item">
                            ...
                            <a href="https://adrianfuzi-portfolio.netlify.com/" target="_blank" rel="noopener noreferrer" className="projects__overlay" onMouseEnter={toggleHover} onMouseLeave={toggleHover}>
                        ...
                        <span className="projects__code"><a className="link" href="https://github.com/adrianfuzi/portfolio" target="_blank" rel="noopener noreferrer">&lt; Check out the code on GitHub &#47;&gt;</a></span>
                    </div>
